export const heroAssets = {
  ...
  hamburger: "/images/hero/hamburger-icon.webp",
  bannerBg: "/images/hero/banner-bg.webp",
  bannerDivider: "/images/hero/banner-hero-divider.webp",
...
export const networkItems = [
  {
    ...
    icon: "/images/hero/network-icons/icon-vanhdai.webp",
  },
  {
    lines: ["Liên", "phường"] as const,
    icon: "/images/hero/network-icons/icon-lienphuong.webp",
  },
  {
    lines: ["Cao tốc", "Long Thành"] as const,
    icon: "/images/hero/network-icons/icon-caotoc.webp",
  },
  {
    lines: ["Thủ", "Thiêm"] as const,
    icon: "/images/hero/network-icons/icon-thuthiem.webp",
  },
  {
    lines: ["Sân bay", "Long Thành"] as const,
    icon: "/images/hero/network-icons/icon-sanbay.webp",
  },
] as const;
